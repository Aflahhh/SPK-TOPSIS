...
<form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card rounded-4">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nuptk" name="nuptk" value="{{ $pegawai->nuptk }}" required>
                </div>
            </div>

            <!-- NIP/NBM -->
            <div class="row mb-3">
                <label for="nbm" class="col-sm-3 col-form-label">NIP/NBM</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nbm" name="nbm" value="{{ $pegawai->nbm }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="tempat" name="tempat" value="{{ old('tempat', explode(', ', $pegawai->ttl)[0] ?? '') }}" required>
                </div>
                <div class="col-sm-4">
                    <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', explode(', ', $pegawai->ttl)[1] ?? '') }}" required>
                </div>
                <input type="text" name="ttl" id="ttl" value="{{ $pegawai->ttl }}">
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="status_perkawinan" name="status_perkawinan" required>
                        ...
                        <option value="Pernah Menikah" {{ $pegawai->status_perkawinan == 'Pernah Menikah' ? 'selected' : '' }}>Pernah Menikah</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="jurusan" name="jurusan" required>
                        <option value="{{ $pegawai->jurusan }}" selected>{{ $pegawai->jurusan }}</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <div class="card rounded-4">
        ...
        <div class="card-body">
                ...
                <div class="col-sm-9">
                    <select name="jabatan_id" id="jabatan_id" class="form-control">
                        ...
                        @foreach ($jabatan as $data)
                            <option value="{{ $data->id }}" {{ $pegawai->jabatan_id == $data->id ? 'selected' : '' }}>{{ $data->nama_jabatan }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="status_karyawan" name="status_karyawan" required>
                        ...
                        <option value="Laki-Laki" {{ $pegawai->status_karyawan == 'K' ? 'selected' : '' }}>Karyawan</option>
                        <option value="Perempuan" {{ $pegawai->status_karyawan == 'TK' ? 'selected' : '' }}>Tidak Karyawan</option>
                    </select>
                </div>
            </div>
            ...
            {{-- status jabatan --}}
            <div class="row mb-3">
                <label for="status_jabatan_id" class="col-sm-3 col-form-label">Status Jabatan</label>
                <div class="col-sm-9">
                    <select name="status_jabatan_id" id="status_jabatan_id" class="form-control">
                        <option value="">Pilih Jabatan</option>
                        @foreach ($status_jabatan as $data)
                            <option value="{{ $data->id }}" {{ $pegawai->status_jabatan_id == $data->id ? 'selected' : '' }}>{{ $data->status_jabatan }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <select name="golongan_id" id="golongan_id" class="form-control">
                        ...
                        @foreach ($golongan as $data)
                            <option value="{{ $data->id }}" {{ $pegawai->golongan_id == $data->id ? 'selected' : '' }}>{{ $data->golongan }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <select name="mapel_id" id="mapel_id" class="form-control">
                        ...
                        @foreach ($mapel as $data)
                            <option value="{{ $data->id }}" {{ $pegawai->mapel_id == $data->id ? 'selected' : '' }}>{{ $data->mapel }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
    ...
    <div class="card rounded-4">
        ...
        <div class="card-body">
            <!-- Tahun Sertifikasi -->
            <div class="row mb-3">
                <label for="tahun_sertifikasi" class="col-sm-3 col-form-label">Tahun Sertifikasi</label>
                <div class="col-sm-9">
                    <input type="date" class="form-control" id="tahun_sertifikasi" name="tahun_sertifikasi" value="{{ $pegawai->tahun_sertifikasi }}">
                </div>
            </div>

            <!-- Tempat Sertifikasi -->
            <div class="row mb-3">
                <label for="tempat_sertifikasi" class="col-sm-3 col-form-label">Tempat Sertifikasi</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="tempat_sertifikasi" name="tempat_sertifikasi" value="{{ $pegawai->tempat_sertifikasi }}">
                </div>
            </div>

            <!-- Mengajar Sekolah Lain -->
            <div class="row mb-3">
                <label for="mengajar_sekolah_lain" class="col-sm-3 col-form-label">Mengajar Sekolah Lain</label>
                <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="mengajar_sekolah_lain" id="ya" value="Ya" {{ $pegawai->mengajar_sekolah_lain == 'Ya' ? 'checked' : '' }}>
                        <label class="form-check-label" for="ya">Ya</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="mengajar_sekolah_lain" id="tidak" value="Tidak" {{ $pegawai->mengajar_sekolah_lain == 'Tidak' ? 'checked' : '' }}>
            ...
            <div class="row mb-3 {{ $pegawai->mengajar_sekolah_lain == 'Ya' ? '' : 'd-none' }}" id="nama-sekolah-container">
                <label for="sekolah_lain" class="col-sm-3 col-form-label">Nama Tempat Mengajar</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="sekolah_lain" name="sekolah_lain" value="{{ $pegawai->sekolah_lain }}">
                </div>
            </div>
        </div>
    </div>
